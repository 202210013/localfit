...
// Dynamically allow localhost with any port for CORS
$origin = $_SERVER['HTTP_ORIGIN'] ?? '';
$allowed_origins = [
    'http://localhost:4200',
    'https://localfit.store',
    "https://localfit-nine.vercel.app",
...
if (in_array($origin, $allowed_origins)) {
    ...
    // Optionally, block or set a default
    // header("Access-Control-Allow-Origin: https://localfit.store");
    header("Access-Control-Allow-Credentials: true");
}
